...
def train_model():
    ...
    clf = RandomForestClassifier(
        n_estimators=2200, n_jobs=-1, min_samples_leaf=3, max_features=35, oob_score=True, min_impurity_decrease=0.000015)
    clf.fit(X, y)
...
if __name__ == "__main__":
    ...
    #    dumps = "seq_vec%i.sav" % window
        dumpmodel = "pssm_forest_redun_huge%i.sav" % window
        train_model()
