...
def predict_fasta(filename, window, enc_dict):
    ...
    for i, pidn in enumerate(prot_id[:50]):
        ...
        clf = pickle.load(open("models/BLOSUM/blosum_adaboost21.sav", "rb"))
        ...
        with open("complete_predictors/BLOSUM_21/Predictions.txt", "a+") as wh:
            wh.write(pidn + "\n")
...
if __name__ == "__main__":
    ...
    window = 21
    offset = window//2
    predict_fasta("datasets/Stride_seqs.fasta", window, enc_dict)
